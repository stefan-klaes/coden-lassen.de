...
<div class="member_cards">
    ...
    <div class="row home_bereich chipsgrey">
        <div class="col-2">
            <span>Ich bin Stefan,
                <?php echo $age ?> Jahre alt, aus der Nähe von Hamburg und ich bin
            </span>
        ...
        <div class="col-2" style="position:relative;text-align:center">
            <img class="colimg darkmode_logo" src="<?php echo imgSrc('stefan-codenlassen-ich.svg', 'darkmode') ?>"
                alt="WordPress Freelancer Stefan" />
        </div>
    </div>

    <!-- bubbles -->
    <div class="home_bereich martop40 home_bereich_none"
        style="max-width: 850px;margin: auto;padding-top: 80px;padding-bottom: 40px;">
    ...
    <div class="home_bereich martop40" style="overflow:hidden;padding-top: 40px;padding-bottom: 40px;">
        ...
        <div class="col-finger">
            ...
            <div class="dinge">
                ...
                <p class="pheros">
                    In meinem eigenen E-Commerce Unternehmen habe ich unsere Website eigenständig aufgebaut. Wir haben
                    individuelles Hundefutter produziert und verschickt. Dabei lag mein Hauptfokus auf der
                    Automatisierung der Shopdaten für die Produktion. So habe ich mit unzähligen Eigenentwicklungen die
                    Abläufe verbessert. Beispielsweise arbeiten unsere Mitarbeiter mit Tablets, auf denen sie Schritt
                    für Schritt durch die Zubereitungen geführt wurden. Die Daten wurden automatisch aus dem Shop
                    bereitgestellt. Des Weiteren habe ich den „Packprozess“ beim Versand optimiert und ein Abo in
                    Eigenentwicklung umgesetzt.
                </p>
            </div>
        </div>
        ...
        <div class="col-finger">
            ...
            <div class="dinge">
                ...
                <p class="pheros">
                    Lange Zeit habe ich als AdTech Manager gearbeitet und Tools entwickelt, die die Prozesse optimieren. 
                    Technologie und Innovation interessieren mich extrem. Nebenberuflich entwickle Plugins oder stelle Codes 
                    für Feature Erweiterungen in WordPress und Woocommerce bereit.
                </p>
            </div>
        </div>
        ...
        <div class="col-finger">
            ...
            <div class="dinge">
                ...
                <p class="pheros">
                    Hauptberuflich arbeite ich als Software Engineer für ein international agierendes deutsches Unternehmen
                    und entwickle Tools, die die Prozesse optimieren. Mein Schwerpunkt ist die Entwicklung von internen Tools 
                    im Bereich Finance, Userinterface in Python mit dem Django Framework.
                </p>
                <a class="btn button_prim martop20" target="_blank"
                    href="https://de.linkedin.com/in/stefan-klaes-51b022b5">Finde mich bei LinkedIn</a>
    ...
    <div class="home_bereich martop40" style="overflow:hidden;padding-top: 40px;padding-bottom: 40px;">
        ...
        <?php
        $skill_chips = ["PYTHON", "DJANGO", "NEXTJS", "REACT", "SOLIDITY", "BLOCKCHAIN", "APIs"];
        foreach ($skill_chips as $chip) {
            ?>
            <div class="chip chipprimopa" style="line-height: 24px;">
                <?php get_icon("bookmark", 24, "inchip") ?>
