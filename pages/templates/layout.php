...
<!DOCTYPE html>
	...
	<body id="body" class="<?php if (isset($_COOKIE["sidenav"])) { echo $_COOKIE["sidenav"]; } ?> <?php echo $darkmode ?>">
		...
		<!-- create new popup -->
		<div id="team_popup" class="popup_closed closepopup box-shadow-3">
                ...
                <div class="account_popup_body">
					...
					<a style="border:none" href="<?php echo sites("ueber-mich") ?>" class="account_popup_row_action hovfill">
						<span>
							<span style="display: inline-block;width: 40px;vertical-align: top;">
								<?php get_icon("person",32,"iniconbox"); ?>
							</span>
							<span class="txt" style="display: inline-block;">
								Stefan Klaes<br>
								WordPress Entwickler<br>
								+<?php echo round(date("Y")-2016) ?> Jahre Erfahrung<br>
								Nähe Hamburg
							</span>
						</span>
					</a>
					...
					<a href="<?php echo sites('kontakt') ?>" class="account_popup_row_action hovfill">
						<span>
